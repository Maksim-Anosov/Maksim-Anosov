...
[![My Skills](https://skillicons.dev/icons?i=js,ts,html,css,scss,react,nextjs,redux,nodejs,git,npm,webpack,vite,jest,cypress,figma,docker,vscode&perline=9)](https://skillicons.dev)
